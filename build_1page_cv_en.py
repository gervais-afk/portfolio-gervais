...
def generate_exact_user_1page_cv_en():
    ...
    bullet(c1, "6 LangGraph agents orchestrated via WikiSkills (skills: critic anti-hallucination, Cypher optimizer), RRF k=60, SHA-256 No-LLM (100%).")
    ...
    bullet(c1, "Ethical sovereign AI, Neo4j GraphRAG pipelines, PostgreSQL, high-dimensional EDA, executive dashboards.")
