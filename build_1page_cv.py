...
def generate_exact_user_1page_cv():
    ...
    entry(c1, "K1-MATHINFO (v3.0.0)", "IA Souveraine Multi-Agents & Certification OKF")
    bullet(c1, "Système souverain DMI (Univ. Ngaoundéré) : 470 thèses, 19 projets M1, graphe Neo4j 1 366 nœuds.")
    bullet(c1, "6 agents LangGraph, RRF k=60 + Cross-Encoder, attesteur SHA-256 No-LLM, 77/77 tests (100%).")
    ...
    bullet(c1, "IA souveraines, pipelines RAG/GraphRAG Neo4j, bases SQL, EDA massive et reporting décisionnel exécutif.")
    ...
    bullet(c1, "ML & Stats Bayésienne, Data Eng. & Neo4j, Vision & Robotique, Cybersécurité & Blockchain, MLOps Souverains.")
